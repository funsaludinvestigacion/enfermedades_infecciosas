...
demo_lab_info <- read.csv("~/enfermedades_infecciosas_final_act/docs/todas_las_fichas.csv")
conteo_criterio <- read.csv("~/enfermedades_infecciosas_final_act/docs/conteo_por_criterio.csv")
conteo_individuo <- read.csv("~/enfermedades_infecciosas_final_act/docs/conteo_por_individuo.csv")
conteo_comunidad <- read.csv("~/enfermedades_infecciosas_final_act/docs/conteo_por_comunidad.csv")
# load map objects
